...
const About = () => {
  return (
    <Section
      id="about"
      classname="flex justify-center bg-linear-to-tl from-white from-50% to-[#ced4da] z-2 relative py-20"
    >
      <div className="w-[min(1100px,90vw)]">
        <div>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-[clamp(25px,5vw,30px)] text-gray-500 leading-12 pt-5"
          >
